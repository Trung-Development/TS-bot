...
export const Event: ClientEvent = {
  ...
  run: async (
    ...
    if (interaction.isChatInputCommand()) {
      ...
      const contextMenu: ContextMenu | undefined = client.contextMenus?.get(
        interaction.commandName,
      );
      ...
      const selectMenuCommand: SelectMenu | undefined =
      ...
      const buttonInteraction: ButtonCommand | undefined =
      ...
      const modalInteraction: ModalForm | undefined = client.modalForms?.get(
